// ⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈
//▮KEED BOT  INC 2022 ®️ALL RIGHTS RESERVED
//▮
...
Drips.hr();
console.log(color(''), color('THANKS FOR CHOOSING KEED BOT ', 'green'))
console.log(color(''), color('SCRIPT BY DRIPS', 'red'))
console.log(color( ''), color('https://wa.me/27634090203','cyan'))
Drips.hr();
Drips.banner(`WESLEY KEED BOT OWNER`)
Drips.ok('WELCOME TO KEED BOT')
...
async function startZimBotInc() {
    const ZimBotInc = ZimBotIncConnect({
        ...
        browser: ['SUB NICE THE KEED OFC','Ubuntu','20.0.04'],
        auth: state,
...
const driphunny = fs.readFileSync('./Zimbot/welcome.wav')
...
const dripbabe = fs.readFileSync('./Zimbot/leave.wav')
...
//by drips
function scheduleGc() {// garbage collector by nice
